...
library(tictoc) # to track time taken for script to run with 2 rep
tic()
{
#############################################
### Setup
...
source("code/code-review/1-core_simulation.R")
source("code/code-review/2-visualization_functions.R")
source("code/code-review/3-simulation_runners.R")
source("code/code-review/4-network_analysis.R")

# Create output directories
output_dir <- "code/code-review/test-introgression_simulation"
