...
if(!exists("metrics_df") || !exists("summary_stats")) {
  load("./output-hybridization/simulation_results.RData")
}
#results <- readRDS("./output-hybridization/simulation_results.rds")
...
# Save plots
ggsave("./output-hybridization/plots/network_evolution.pdf", evolution_plot, width = 12, height = 10)
ggsave("./output-hybridization/plots/network_relationships.pdf", relationship_plot, width = 15, height = 5)
